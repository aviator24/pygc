...
if __name__ == '__main__':
    ...
    if args.twophase:
        if args.mpi:
            fname_local = "gc.{:04d}.{:04d}.2p.tavg.{}".format(args.start, args.end, COMM.rank)
        fname_global = "gc.{:04d}.{:04d}.2p.tavg".format(args.start, args.end)
    else:
        if args.mpi:
            fname_local = "gc.{:04d}.{:04d}.tavg.{}".format(args.start, args.end, COMM.rank)
        fname_global = "gc.{:04d}.{:04d}.tavg".format(args.start, args.end)
